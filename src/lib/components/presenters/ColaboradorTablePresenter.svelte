...
<div class="space-y-6">
  ...
  <TableContainer
    ...
    emptyTitle={hasFiltersApplied ? 'Nenhum colaborador encontrado com os filtros aplicados.' : 'Nenhum colaborador cadastrado ainda.'}
    emptyMessage={hasFiltersApplied ? 'Tente ajustar os filtros.' : 'Cadastre seu primeiro colaborador.'}
    emptyActionLabel={!hasFiltersApplied ? 'Cadastrar Primeiro Colaborador' : ''}
    on:emptyAction={() => { dispatch('novoColaborador'); console.log('🚀 Botão Novo Colaborador clicado'); }}
  >
