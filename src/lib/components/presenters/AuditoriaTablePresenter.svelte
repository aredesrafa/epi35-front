  ...
  <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-4">
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
      ...
      <div>
        ...
        <SearchableDropdown
          options={[
            ...
            ...almoxarifados.map(a => ({ value: a.id, label: a.nome }))
          ]}
          value={filters.almoxarifadoId || ''}
          placeholder="Todos os almoxarifados"
          on:change={(e) => handleFilterInput('almoxarifadoId', e.detail)}
        />
      </div>
      ...
      <div>
        ...
        <SearchableDropdown
           options={[
            { value: '', label: 'Todos os EPIs' },
            ...tiposEpi.map(t => ({ value: t.id, label: `${t.nomeEquipamento} (CA ${t.numeroCA})` }))
           ]}
           value={filters.tipoEpiId || ''}
           placeholder="Todos os EPIs"
           on:change={(e) => handleFilterInput('tipoEpiId', e.detail)}
        />
      </div>
      ...
      <div>
        ...
        <SearchableDropdown
          ...
          placeholder="Todos os tipos"
           on:change={(e) => handleFilterInput('tipoMovimentacao', e.detail)}
        />
      </div>
      ...
      <div>
        ...
        <SearchableDropdown
           ...
           on:change={(e) => handleFilterInput('usuarioId', e.detail)}
        />
      </div>
