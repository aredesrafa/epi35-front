  ...
  <Dropdown placement="bottom-start" class="w-72">
    <div class="p-3 border-b border-gray-200 dark:border-gray-700">
      <Input 
        ...
        placeholder={$_('company.search_placeholder')}
        size="sm"
        class="rounded-sm"
      />
    </div>
    ...
    {#if groupedCompanies.admin.length > 0}
      <div class="px-4 py-2">
        <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">{$_('company.admin')}</h4>
      </div>
    ...
    {#if groupedCompanies.holding.length > 0}
      <div class="px-4 py-2 {groupedCompanies.admin.length > 0 ? 'border-t border-gray-200 dark:border-gray-700' : ''}">
        <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">{$_('company.holdings')}</h4>
      </div>
    ...
    {#if groupedCompanies.contratada.length > 0}
      <div class="px-4 py-2 {(groupedCompanies.admin.length > 0 || groupedCompanies.holding.length > 0) ? 'border-t border-gray-200 dark:border-gray-700' : ''}">
        <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">{$_('company.contratadas')}</h4>
      </div>
