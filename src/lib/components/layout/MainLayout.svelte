<script lang="ts">
  ...
  $: menuItems = [
    ...
    { 
      href: `${base}/fichas`, 
      label: $_('menu.fichas_epi'), 
      icon: FileDocOutline 
    },
    { 
      label: $_('menu.stock_management'), 
      icon: FolderOpenOutline,
      dropdown: [
        { href: `${base}/estoque`, label: $_('menu.stock') },
        { href: `${base}/notas`, label: $_('menu.notes') },
        { href: `${base}/catalogo`, label: $_('menu.catalog') }
      ]
    },
    { 
      label: $_('menu.reports'), 
      icon: ChartOutline,
      dropdown: [
        { href: `${base}/relatorios/auditoria`, label: $_('menu.audit') }
      ]
    }
  ];
